...
|---|---|---|
| Atkinson Hyperlegible (Braille Institute of America) | шрифт интерфейса, `app/src/main/res/font/atkinson_*.ttf` | SIL Open Font License 1.1, [текст](licenses/OFL-AtkinsonHyperlegible.txt) |
| JetBrains Mono | шрифт позывных и чисел, `app/src/main/res/font/jetbrains_mono_*.ttf` | SIL Open Font License 1.1, [текст](licenses/OFL-JetBrainsMono.txt) |
