...
val Sans = FontFamily(
    Font("font/atkinson_regular.ttf", FontWeight.Normal),
    Font("font/atkinson_bold.ttf", FontWeight.Bold),
)
val Mono = FontFamily(
    Font("font/jetbrains_mono_medium.ttf", FontWeight.Medium),
    Font("font/jetbrains_mono_bold.ttf", FontWeight.Bold),
)
